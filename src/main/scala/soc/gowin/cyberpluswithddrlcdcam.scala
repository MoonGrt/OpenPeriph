// VexRiscv CyberPlusWithDdrLcdCam demo
package soc.gowin
...
case class CyberPlusWithDdrLcdCamConfig(
...
object CyberPlusWithDdrLcdCamConfig {
  def default = {
    val config = CyberPlusWithDdrLcdCamConfig(
      ...
      cpuPlugins = ArrayBuffer(
        ...
        new YamlPlugin("rtl/CyberPlusWithDdrLcdCam.yaml")
      )
    )
    config
  }
...
class CyberPlusWithDdrLcdCam(config: CyberPlusWithDdrLcdCamConfig) extends Component {
  // Legacy constructor
  def this(axiFrequency: HertzNumber) {
    this(CyberPlusWithDdrLcdCamConfig.default.copy(axiFrequency = axiFrequency))
  }
...
/* ---------------------------------- Demo Gen --------------------------------- */
/* ----------------------------------------------------------------------------- */
// CyberPlusWithDdrLcdCam-SoC with memory init
object CyberPlusWithDdrLcdCam {
  def main(args: Array[String]) {
    val config =
      SpinalConfig(verbose = true, targetDirectory = "rtl").dumpWave()
    val report = config.generateVerilog(
      InOutWrapper(
        new CyberPlusWithDdrLcdCam(
          CyberPlusWithDdrLcdCamConfig.default.copy(
