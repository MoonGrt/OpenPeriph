...
// class cyberwithallperiph(config: cyberwithallperiphConfig) extends Component {
//   val io = new Bundle {
...
//     // CAN接口
//     val can1 = master(CanMaster())
//     val can2 = master(CanMaster())
...
//         sdio.io.apb -> SizeMapping(0x40018000, 1 kB),
//         can1.io.apb -> SizeMapping(0x40006400, 1 kB),
//         can2.io.apb -> SizeMapping(0x40006800, 1 kB),
//         crc.io.apb -> SizeMapping(0x40023000, 1 kB),
...
//                    sdio.io.interrupt || can1.io.interrupt ||
//                    can2.io.interrupt || crc.io.interrupt ||
//                    uart.io.interrupt
//   }
// }

// // 生成Verilog的示例
// object cyberwithallperiph {
//   def main(args: Array[String]) {
//     val config = cyberwithallperiphConfig()
//     SpinalConfig(
//       targetDirectory = "rtl",
//       defaultConfigForClockDomains = ClockDomainConfig(
//         resetKind = BOOT
//       )
//     ).generateVerilog(new cyberwithallperiph(config))
//   }
// }
